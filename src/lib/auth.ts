    ...
    GoogleProvider({
      ...
      authorization: {
        params: {
          ...
          access_type: "offline",
          response_type: "code",
          scope: "openid email profile https://www.googleapis.com/auth/drive https://www.googleapis.com/auth/drive.metadata https://www.googleapis.com/auth/drive.activity https://www.googleapis.com/auth/gmail.send",
        },
      },
    }),
  ],
